...
sudo docker exec -d clab-frr01-Edge_server4 ip route add 172.22.228.0/24 via 10.0.5.65 dev eth1
...
sudo docker exec -d clab-frr01-client16 ip route add 172.22.228.0/24 via 10.0.2.193 dev eth1
